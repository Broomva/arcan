  ...
  return (
    <>
      <section
        ...
        className="relative overflow-hidden bg-blue-900 pt-[140px] md:pt-[150px] lg:pt-[160px]"
      >
            ...
            <div className="w-full px-8">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Open-source AI Web3 tooling platform for decentralized customization of AI agents
                </h1>
                ...
                {/* <p className="text-neutral-200 text-xs sm:text-base h-[3rem]  ">
                  
                </p> */}
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  
                  Create context-aware AI agents to improve experiences, engagement,
                  understand user behavior,
                  <br />
                  and personalize user profiles on top of Web3.
                  <br />
